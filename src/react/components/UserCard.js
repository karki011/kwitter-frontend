			...
			<React.Fragment>
				<Card>
					...
					<Card.Content>
						...
						<Card.Meta>
							<span className="date">Created: {new Date(this.props.createdAt).toDateString()}</span>
						</Card.Meta>
						<Card.Description>
...
export default connect(mapStateToProps)(withAsyncAction('users', 'getUser')(UserCard));
